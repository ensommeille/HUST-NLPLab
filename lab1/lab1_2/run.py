...
from model import CWS
from dataloader import Sentence
from data_u import handle_data, get_texts_for_new_word_discovery, update_dictionary
from new_word_discovery import find_new_words
...
def main(args):
    ...
    # 更新词典
    update_dictionary(new_words)

    # 保存更新后的词典
    with open('data/datasave.pkl', 'wb') as outp:
